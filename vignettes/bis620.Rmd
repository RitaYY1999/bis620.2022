...
From our analysis, we could conclude that intervention types, genders, ages and health conditions are associated with the adverse event affected rate. Their associations give insights on intervention type decision making for different groups of patients to reduce adverse event affected rate and seriousness.

More specifically, healthy people are less likely to have adverse event than people with underlying disease. Adults are less likely to have serious adverse event than children or older adults. Biological and drug interventions are more likely to result in serious adverse event than behavioral intervention. 
